#
# Deploy_MinViableArchitecture.ps1
#
param(
...
$networkResourceGroupName = "tsmva-public-dmz-network-rg"
$workloadResourceGroupName = "tsmva-public-dmz-wl-rg"
...
#Not part of minimum viable - we don't use the public or private dmz, instead we just jump-box to the management subnet.  We
#also don't need a VPN because we're not establishing on-premise connectivity
